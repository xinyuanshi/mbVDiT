...
def normal_train_diff(model,
    ...
    for epoch in t_epoch:
        epoch_loss = 0.
        for i, (x, x_cond, cond, age_cond, _, _, _) in enumerate(dataloader): # 去掉了, celltype
            ...
            noise_pred = model(x_noisy, t=timesteps.to(device), y=cond_emb, a=age_cond, ob=ob_cond.to(device))
