...
def map(dataset1, dataset2, i):
    ...
    #datasets = np.corrcoef(dataset1)
    #map_ndarray = np.corrcoef(dataset2)
    ...
    row_clusters = linkage(pdist(dataset1, metric='euclidean'), method='ward') #dataset2  dataset1
    col_clusters = linkage(pdist(dataset1.T, metric='euclidean'), method='ward')
    row_order = dendrogram(row_clusters, no_plot=True)['leaves']
    col_order = dendrogram(col_clusters, no_plot=True)['leaves']
    test_data = pd.DataFrame(dataset2)
    ...
    save_dir = 'D:\\PyCharm\\Py_Projects\\DiTT\\heatmap_1\\hnscc\\'
...
VDiT_csv1 = pd.read_csv('D:\\PyCharm\\Py_Projects\\DiTT\\result\\data_hnscc\\original.csv', index_col=0)
VDiT_csv2 = pd.read_csv('D:\\PyCharm\\Py_Projects\\DiTT\\result\\data_hnscc\\prediction.csv', index_col=0)
DeepImpute_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DeepImpute/DeepImpute_hnscc_prediction.csv', index_col=0)
AutoImpute_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/AutoImpute/AutoImpute_hnscc_prediction.csv', index_col=0)
DCA_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DCA/DCA_hnscc_prediction.csv', index_col=0)
CpG_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/CpG/CpG_hnscc_prediction.csv', index_col=0)
scVI_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/scVI/scVI_hnscc_prediction.csv', index_col=0)
DeepMicroGen_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DeepMicroGen/DeepMicroGen_hnscc_prediction.csv', index_col=0)
...
DeepImpute_csv1 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DeepImpute/DeepImpute_ucec_origin.csv', index_col=0)
DeepImpute_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DeepImpute/DeepImpute_ucec_prediction.csv', index_col=0)

AutoImpute_csv1 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/AutoImpute/AutoImpute_ucec_origin.csv', index_col=0)
AutoImpute_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/AutoImpute/AutoImpute_ucec_prediction.csv', index_col=0)

DCA_csv1 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DCA/DCA_ucec_origin.csv', index_col=0)
DCA_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DCA/DCA_ucec_prediction.csv', index_col=0)

CpG_csv1 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/CpG/CpG_ucec_origin.csv', index_col=0)
CpG_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/CpG/CpG_ucec_prediction.csv', index_col=0)

scVI_csv1 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/scVI/scVI_ucec_origin.csv', index_col=0)
scVI_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/scVI/scVI_ucec_prediction.csv', index_col=0)

DeepMicroGen_csv1 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DeepMicroGen/DeepMicroGen_ucec_origin.csv', index_col=0)
DeepMicroGen_csv2 = pd.read_csv('D:/PyCharm/Py_Projects/Diffusion/baseline_result/DeepMicroGen/DeepMicroGen_ucec_prediction.csv', index_col=0)
...
plt.savefig('D:\\PyCharm\\Py_Projects\\DiTT\\heatmap_3\\ucec.pdf', format='pdf', bbox_inches='tight')
